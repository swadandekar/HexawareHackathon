    ...
    handler: async (request, response) => {
        ...
        if (blockAddedStatus && currentTimeStamp - dbTimeStamp < 300) {
            ...
            if (currentTimeStamp - dbTimeStamp > 300) {
                ...
                return "Before registering the star, the request should be validated. Please proceed with validation.";
            }
        }
    }
});
    ...
    handler: async (request, response) => {
      ...
      await blockChain.deleteValueFromDB(request.payload.address + '_blockAdded');
        ...
        if (dbTimeStamp === "NotFound") {
            ...
            objUserRequest.message = objUserRequest.address + ":" + objUserRequest.requestTimeStamp + ":StarRegistry";
